...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtTokenProvider jwtTokenProvider, JwtAuthentcationEntryPoint jwtAuthentcationEntryPoint, JwtAccessDeniedHandler jwtAccessDeniedHandler) {
