...
import com.mmd.oauth2.application.dto.OAuth2Member;
import com.mmd.oauth2.application.dto.OAuthAttributes;
...
public class OAuth2Service implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Member getMember(OAuthAttributes attributes, SocialType socialType) {
        ...
        return memberRepository.findBySocialTypeAndSocialId(socialType, attributes.getOAuth2Member().getSocialId())
                .orElse(saveMember(attributes, socialType));
    }
